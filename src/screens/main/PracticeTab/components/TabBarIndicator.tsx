...
export default class TabBarIndicator extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "getTranslateX", (position: any, routes: any, getTabWidth: any) => {
  ...
  render() {
    ...
    const widthIfUndefine = width == `${100 / routes.length}%` ? DEFAULT_WIDTH : width
    ...
    return /*#__PURE__*/React.createElement(Animated.View, {
      ...
      layout.width && Platform.OS !== 'macos' ? {
        left: (getTabWidth() - widthIfUndefine) / 2,
      } : {
