...
declare class Calendar extends Component<CalendarProps, State> {
    ...
    static propTypes: {
        ...
        disableArrowRight: PropTypes.Requireable<boolean>; /** Specify theme properties to override specific styles for calendar parts. Default = {} */
        disabledDaysIndexes: PropTypes.Requireable<(number | null | undefined)[]>; /** Specify style for calendar container element. Default = {} */
