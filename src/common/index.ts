...
export const STRINGS = {
  ...
  VISITED_SCREEN: {
    ...
    THE_NAME_OF_EXAMINATION_CANNOT_BE_LEFT_BLANK:
      'Không được để trống tên lần khám',
  ...
  ROUTE: {
    ...
    ADD_MEDICINE_SCREEN: 'ADD_MEDICINE_SCREEN',
...
export interface VisitedItemDisplay {
  _id: number;
  title: string;
  pre: number; //id of pre visited
  location: Location;
...
export interface MedicineItemDisplay {
  _id: number;
  title: string;
  infor: PicNote;
  schedules: Array<Schedule>;
...
export const CALENDAR_STYLES = {
  VISITED: {
    key: 'Visited',
    color: COLORS.EVENT_TAG.Visited.borderColor,
    selectedDotColor: 'blue',
  },
  MEDICINE: {
    key: 'Medicine',
    color: COLORS.EVENT_TAG.Medicine.borderColor,
    selectedDotColor: 'blue',
  },
};
